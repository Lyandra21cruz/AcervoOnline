...
$sql = "SELECT * FROM livros WHERE categoria = 'biografia' ORDER BY id_livro DESC";
...
<head>
    ...
    <title>Biografia - Acervo Online</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="page-header">
            ...
            <h1 class="page-title">Biografia𖥔</h1>
            <p class="page-subtitle">"A história real que nos move e inspira a agir."</p>
        </header>
        <br><br><br><br>
        <main>
