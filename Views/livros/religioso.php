...
$sql = "SELECT * FROM livros WHERE categoria = 'religioso' ORDER BY id_livro DESC";
...
<head>
    ...
    <title>Religioso - Acervo Online</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="page-header">
            ...
            <p class="page-subtitle">"Encontre sua Paz Interior. Mensagens que fortalecem a alma e iluminam o caminho."</p>
        </header>
        <br><br><br><br>
        <main>
