...
$sql = "SELECT * FROM livros WHERE categoria = 'historia' ORDER BY id_livro DESC";
...
<head>
    ...
    <title>História - Acervo Online</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="page-header">
            ...
            <h1 class="page-title">História 𓀚</h1>
            <p class="page-subtitle">"Aprenda com o Passado. Entenda quem você é, descobrindo quem eles foram."</p>
        </header>
        <br><br><br><br>
        <main>
