...
$sql = "SELECT * FROM livros WHERE categoria = 'aventura' ORDER BY id_livro DESC";
...
<head>
    ...
    <title>Aventura - Acervo Online</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="page-header">
            ...
            <h1 class="page-title">Aventura ˚˖𓍢ִ໋🍃˚.⛰️⋆☁️</h1>
            <p class="page-subtitle">"O mundo está à espera. Prepare-se para a jornada!"</p>
        </header>
        <br><br><br><br>
        <main>
