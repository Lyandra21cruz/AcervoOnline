...
$sql = "SELECT * FROM livros WHERE categoria = 'infantil' ORDER BY id_livro DESC";
...
<head>
    ...
    <title>Infantil - Acervo Online</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="page-header">
            ...
            <h1 class="page-title">Infantil 𖠋</h1>
            <p class="page-subtitle">"Cresça Sonhando. A magia da primeira leitura que inspira o futuro."</p>
        </header>
        <br><br><br><br>
        <main>
