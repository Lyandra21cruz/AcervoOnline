...
$sql = "SELECT * FROM livros WHERE categoria = 'academico' ORDER BY id_livro DESC";
...
<head>
    ...
    <title>Academico - Acervo Online</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="page-header">
            ...
            <h1 class="page-title">Acadêmico📖</h1>
            <p class="page-subtitle">"Seja Autoridade. O investimento que transforma sua visão e define seu sucesso."
            </p>
        </header>
        <br><br><br><br>
        <main>
