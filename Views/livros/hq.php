...
$sql = "SELECT * FROM livros WHERE categoria = 'hq' ORDER BY id_livro DESC";
...
<head>
    ...
    <title>HQ/Mangás - Acervo Online</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="page-header">
            ...
            <h1 class="page-title">HQ / Mangás 🍵</h1>
            <p class="page-subtitle">"Ação Imediata. Experiencie a narrativa no ritmo vibrante da arte."</p>
        </header>
        <br><br><br><br>
        <main>
