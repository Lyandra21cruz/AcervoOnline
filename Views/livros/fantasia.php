...
$sql = "SELECT * FROM livros WHERE categoria = 'fantasia' ORDER BY id_livro DESC";
...
<head>
    ...
    <title>Fantasia - Acervo Online</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="page-header">
            ...
            <p class="page-subtitle">"Fantasias são sonhos que a gente veste para viver a imaginação."</p>
        </header>
        <br><br><br><br>
        <main>
