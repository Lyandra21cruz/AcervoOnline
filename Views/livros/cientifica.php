...
$sql = "SELECT * FROM livros WHERE categoria = 'cientifica' ORDER BY id_livro DESC";
...
<head>
    ...
    <title>Ficção Cientifica - Acervo Online</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="page-header">
            ...
            <p class="page-subtitle">"Pense Além. A jornada que expande sua mente para universos de novas
                possibilidades."</p>
        </header>
        <br><br><br><br>
        <main>
