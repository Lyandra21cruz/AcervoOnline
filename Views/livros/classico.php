...
$sql = "SELECT * FROM livros WHERE categoria = 'classico' ORDER BY id_livro DESC";
...
<head>
    ...
    <title>Clássicos da Literatura - Acervo Online</title>
    ...
    <style>
        ...
        .detalhes-info p {
            ...
            margin: 6px 0;
            color: #000000ff;
            /* texto mais visível em branco */
        }

        .detalhes-info strong {
            font-weight: 700;
            color: #4b2e2e;
            /* labels em marrom escuro */
        }
...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="page-header">
            ...
            <h1 class="page-title">Clássicos da Literatura ✎</h1>
            <p class="page-subtitle">"O Legado do Pensamento. Conecte-se com as ideias que moldaram o mundo moderno."
            </p>
        </header>
        <br><br><br><br>
        <main>
