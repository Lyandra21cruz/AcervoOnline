...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="page-header">
            ...
            <h1 class="page-title">Clássicos da Literatura ✎ᝰ.ᐟ⋆⑅˚₊</h1>
            <p class="page-subtitle">"O Legado do Pensamento. Conecte-se com as ideias que moldaram o mundo moderno."</p>
        </header>
        <br><br><br><br>
        <main>
